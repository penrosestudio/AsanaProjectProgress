/*
AsanaProjectProgress - v0.0.3, October 24th 2013
	...
	request.get("https://app.asana.com/api/1.0/workspaces/"+workspace+"/projects?archived=false&opt_fields=name,id,modified_at,created_at", requestOptions, function(error, resp, body) {
		...
		var projects = body.data,
			getNextProjectTasks = function(finalCallback) {
				...
				request.get("https://app.asana.com/api/1.0/tasks?project="+projectId+"&include_archived=true&opt_fields=completed,modified_at,created_at,completed_at", requestOptions, function(error, resp, body) {
					if(!error) {
						var tasks = body.data,
